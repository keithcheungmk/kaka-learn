...
python3 scripts/qa-report.py         # 預填檢查報告（配合 docs/qa-check.md；≤5min）
...
| `scripts/smoke-shots.py` | 預設家庭裝置（iPad Pro 11 直／橫 + iPhone 16 Pro Max）：溢出／白屏／404／console error；`--all` 先跑舊全尺寸 |
