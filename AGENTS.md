...
- 另有可擴充主題（繁體表面形 + 系統 Emoji），例如：
  ...
  - 職業：醫生、護士、老師、消防員、警察、廚師、司機、農夫、機師、空中服務員、太空人、牙醫、獸醫、科學家、畫家、音樂家、運動員、巴士司機、建築工人、髮型師、環境保護主任、醫療銷售代表、郵差、救護員、售貨員、保安、清潔工人、救生員、飼養員、船長、漁夫、送貨員、攝影師（難明概念用雙 emoji，如 🚌🧑；環保主任用 ♻️🕵️；保安用 🚪🧑；漁夫用 🎣🧑；救生員用 🏊🛟）
...
- 全頁**鎖死放大縮細**（iPad／妙控鍵盤 pinch 唔好放大遊戲）。砌練習以撳為主，拖係額外。
- 家長 PIN 預設 `1234`，要可以改。
- 鹿類重點開關會提高鹿詞抽中權重。
