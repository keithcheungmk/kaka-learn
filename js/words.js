...
const WORDS = [
  ...
  { id: 'ba_char', term: '爸', isDeer: false, emoji: '👨', badge: '', plate: '#2a3548' },
  { id: 'ming_char', term: '明', isDeer: false, emoji: '🌞', badge: '', plate: '#2a3548' },
  { id: 'you_char', term: '友', isDeer: false, emoji: '🫂', badge: '', plate: '#2a3548' },
  ...
  // 《我自己會讀》紅輯 Gemini 校準詞（單字／詞組）
  { id: 'yige', term: '一個', isDeer: false, emoji: '1️⃣', badge: '', plate: '#2a3548' },
  { id: 'yifeng_letter', term: '一封', isDeer: false, emoji: '✉️', badge: '', plate: '#2a3548' },
  { id: 'yiba', term: '一把', isDeer: false, emoji: '☝️', badge: '', plate: '#2a3548' },
  { id: 'yishu_bunch', term: '一束', isDeer: false, emoji: '💐', badge: '', plate: '#143828' },
  { id: 'yipian', term: '一片', isDeer: false, emoji: '🍃', badge: '', plate: '#143828' },
  { id: 'sange', term: '三個', isDeer: false, emoji: '3️⃣', badge: '', plate: '#2a3548' },
  { id: 'xialai', term: '下來', isDeer: false, emoji: '⬇️', badge: '', plate: '#2a3548' },
  { id: 'buyao', term: '不要', isDeer: false, emoji: '🙅', badge: '', plate: '#402020' },
  { id: 'bujian', term: '不見', isDeer: false, emoji: '🙈', badge: '', plate: '#2a2a35' },
  { id: 'ganbei', term: '乾杯', isDeer: false, emoji: '🥂', badge: '', plate: '#3a3010' },
  { id: 'wuge', term: '五個', isDeer: false, emoji: '5️⃣', badge: '', plate: '#2a3548' },
  { id: 'di_low', term: '低', isDeer: false, emoji: '⬇️', badge: '', plate: '#2a3548' },
  { id: 'ting_stop', term: '停', isDeer: false, emoji: '🛑', badge: '', plate: '#401820' },
  { id: 'shangxin', term: '傷心', isDeer: false, emoji: '😢', badge: '', plate: '#1a3050' },
  { id: 'guangtutu', term: '光禿禿', isDeer: false, emoji: '🌳', badge: '', plate: '#3a3010' },
  { id: 'liangge', term: '兩個', isDeer: false, emoji: '2️⃣', badge: '', plate: '#2a3548' },
  { id: 'liangpian', term: '兩片', isDeer: false, emoji: '🍂', badge: '', plate: '#3a3010' },
  { id: 'gongji', term: '公雞', isDeer: false, emoji: '🐓', badge: '', plate: '#402020' },
  { id: 'dongdong', term: '冬冬', isDeer: false, emoji: '🧒', badge: '', plate: '#2a3548' },
  { id: 'qule', term: '去了', isDeer: false, emoji: '👋', badge: '', plate: '#2a3548' },
  { id: 'ya_excl', term: '呀', isDeer: false, emoji: '😮', badge: '', plate: '#2a3548' },
  { id: 'guagua', term: '呱呱', isDeer: false, emoji: '🐸', badge: '', plate: '#143820' },
  { id: 'huhu', term: '呼呼', isDeer: false, emoji: '🌬️', badge: '', plate: '#0f3550' },
  { id: 'gugu', term: '咕咕', isDeer: false, emoji: '🐓', badge: '', plate: '#402020' },
  { id: 'kule', term: '哭了', isDeer: false, emoji: '😭', badge: '', plate: '#1a3050' },
  { id: 'a_excl', term: '啊', isDeer: false, emoji: '😲', badge: '', plate: '#2a3548' },
  { id: 'chuanqi', term: '喘氣', isDeer: false, emoji: '😮‍💨', badge: '', plate: '#2a3548' },
  { id: 'xihuan', term: '喜歡', isDeer: false, emoji: '❤️', badge: '', plate: '#401028' },
  { id: 'miaomiao', term: '喵喵', isDeer: false, emoji: '🐱', badge: '', plate: '#4a2030' },
  { id: 'gaga', term: '嘎嘎', isDeer: false, emoji: '🦆', badge: '', plate: '#143828' },
  { id: 'sige', term: '四個', isDeer: false, emoji: '4️⃣', badge: '', plate: '#2a3548' },
  { id: 'huilai', term: '回來', isDeer: false, emoji: '↩️', badge: '', plate: '#2a3548' },
  { id: 'zuoxia', term: '坐下', isDeer: false, emoji: '🪑', badge: '', plate: '#3a2818' },
  { id: 'daxiao', term: '大小', isDeer: false, emoji: '↕️', badge: '', plate: '#2a3548' },
  { id: 'dabu', term: '大步', isDeer: false, emoji: '🚶', badge: '', plate: '#2a3548' },
  { id: 'tianshang', term: '天上', isDeer: false, emoji: '☁️', badge: '', plate: '#0f3550' },
  { id: 'haoweidao', term: '好味道', isDeer: false, emoji: '😋', badge: '', plate: '#3a3010' },
  { id: 'haokan', term: '好看', isDeer: false, emoji: '😍', badge: '', plate: '#401028' },
  { id: 'zi_char', term: '字', isDeer: false, emoji: '🔤', badge: '', plate: '#2a3548' },
  { id: 'anan', term: '安安', isDeer: false, emoji: '🧒', badge: '', plate: '#2a3548' },
  { id: 'jichu', term: '寄出', isDeer: false, emoji: '📮', badge: '', plate: '#3a3010' },
  { id: 'xiaoxin', term: '小心', isDeer: false, emoji: '⚠️', badge: '', plate: '#3a3010' },
  { id: 'xiaoming', term: '小明', isDeer: false, emoji: '👦', badge: '', plate: '#2a3548' },
  { id: 'dong_understand', term: '懂', isDeer: false, emoji: '💡', badge: '', plate: '#2a3548' },
  { id: 'dakai', term: '打開', isDeer: false, emoji: '📂', badge: '', plate: '#2a3548' },
  { id: 'lazhu', term: '拉住', isDeer: false, emoji: '🪢', badge: '', plate: '#3a3010' },
  { id: 'zhuomicang', term: '捉迷藏', isDeer: false, emoji: '🫣', badge: '', plate: '#2a2a35' },
  { id: 'zhai', term: '摘', isDeer: false, emoji: '🤏', badge: '', plate: '#143828' },
  { id: 'mobudao', term: '摸不到', isDeer: false, emoji: '🤚', badge: '', plate: '#2a3548' },
  { id: 'jianqi', term: '撿起', isDeer: false, emoji: '🫴', badge: '', plate: '#143828' },
  { id: 'dang_block', term: '擋', isDeer: false, emoji: '🛡️', badge: '', plate: '#2a3548' },
  { id: 'shoudao', term: '收到', isDeer: false, emoji: '📩', badge: '', plate: '#3a3010' },
  { id: 'shouqi', term: '收起', isDeer: false, emoji: '🌂', badge: '', plate: '#0f3550' },
  { id: 'duanle', term: '斷了', isDeer: false, emoji: '💥', badge: '', plate: '#401820' },
  { id: 'guoguo', term: '果果', isDeer: false, emoji: '🍎', badge: '', plate: '#401820' },
  { id: 'zhitou', term: '枝頭', isDeer: false, emoji: '🌿', badge: '', plate: '#143828' },
  { id: 'cheng_orange', term: '橙', isDeer: false, emoji: '🍊', badge: '', plate: '#402410' },
  { id: 'huanying', term: '歡迎', isDeer: false, emoji: '🤗', badge: '', plate: '#3a3010' },
  { id: 'wangwang', term: '汪汪', isDeer: false, emoji: '🐶', badge: '', plate: '#3a3010' },
  { id: 'liangkuai', term: '涼快', isDeer: false, emoji: '😌', badge: '', plate: '#0f3550' },
  { id: 'zhunbei', term: '準備', isDeer: false, emoji: '📋', badge: '', plate: '#2a3548' },
  { id: 'dida', term: '滴答', isDeer: false, emoji: '💧', badge: '', plate: '#0f3550' },
  { id: 'mandi', term: '滿地', isDeer: false, emoji: '🍂', badge: '', plate: '#3a3010' },
  { id: 'yongli', term: '用力', isDeer: false, emoji: '💪', badge: '', plate: '#402010' },
  { id: 'bai_color', term: '白', isDeer: false, emoji: '⬜', badge: '', plate: '#3a3a45' },
  { id: 'kanbujian', term: '看不見', isDeer: false, emoji: '👀', badge: '', plate: '#2a2a35' },
  { id: 'qiutian', term: '秋天', isDeer: false, emoji: '🍁', badge: '', plate: '#3a3010' },
  { id: 'xiaole', term: '笑了', isDeer: false, emoji: '😄', badge: '', plate: '#3a3010' },
  { id: 'kuai_chopsticks', term: '筷', isDeer: false, emoji: '🥢', badge: '', plate: '#3a2818' },
  { id: 'hong_color', term: '紅', isDeer: false, emoji: '🟥', badge: '', plate: '#401018' },
  { id: 'hongsan', term: '紅傘', isDeer: false, emoji: '☂️', badge: '', plate: '#401018' },
  { id: 'zi_color', term: '紫', isDeer: false, emoji: '🟪', badge: '', plate: '#281840' },
  { id: 'lv_color', term: '綠', isDeer: false, emoji: '🟩', badge: '', plate: '#143820' },
  { id: 'xian_string', term: '線', isDeer: false, emoji: '🧵', badge: '', plate: '#3a3010' },
  { id: 'meili', term: '美麗', isDeer: false, emoji: '✨', badge: '', plate: '#401028' },
  { id: 'laoshu', term: '老鼠', isDeer: false, emoji: '🐭', badge: '', plate: '#2a2a35' },
  { id: 'huasan', term: '花傘', isDeer: false, emoji: '☂️', badge: '', plate: '#401028' },
  { id: 'luo_fall', term: '落', isDeer: false, emoji: '🍂', badge: '', plate: '#3a3010' },
  { id: 'lan_color', term: '藍', isDeer: false, emoji: '🟦', badge: '', plate: '#0f3550' },
  { id: 'lide', term: '裏的', isDeer: false, emoji: '📦', badge: '', plate: '#2a3548' },
  { id: 'qingke', term: '請客', isDeer: false, emoji: '🍽️', badge: '', plate: '#3a3010' },
  { id: 'tanchi', term: '貪吃', isDeer: false, emoji: '😋', badge: '', plate: '#402410' },
  { id: 'qichuang', term: '起床', isDeer: false, emoji: '🛏️', badge: '', plate: '#2a3548' },
  { id: 'gen', term: '跟', isDeer: false, emoji: '👉', badge: '', plate: '#2a3548' },
  { id: 'lu_road', term: '路', isDeer: false, emoji: '🛣️', badge: '', plate: '#2a2a35' },
  { id: 'duo_hide', term: '躲', isDeer: false, emoji: '🙈', badge: '', plate: '#2a2a35' },
  { id: 'qingqing', term: '輕輕', isDeer: false, emoji: '🪶', badge: '', plate: '#2a3548' },
  { id: 'jin_near', term: '近', isDeer: false, emoji: '📍', badge: '', plate: '#2a3548' },
  { id: 'zhuizhu', term: '追逐', isDeer: false, emoji: '🏃', badge: '', plate: '#3a3010' },
  { id: 'songgei', term: '送給', isDeer: false, emoji: '🎁', badge: '', plate: '#401028' },
  { id: 'zheshi', term: '這是', isDeer: false, emoji: '👉', badge: '', plate: '#2a3548' },
  { id: 'yuan_far', term: '遠', isDeer: false, emoji: '🔭', badge: '', plate: '#0f3550' },
  { id: 'kaile', term: '開了', isDeer: false, emoji: '🌸', badge: '', plate: '#401028' },
  { id: 'qingcaodi', term: '青草地', isDeer: false, emoji: '🌱', badge: '', plate: '#143820' },
  { id: 'piao', term: '飄', isDeer: false, emoji: '🍃', badge: '', plate: '#143828' },
  { id: 'feiwu', term: '飛舞', isDeer: false, emoji: '🦋', badge: '', plate: '#143828' },
  { id: 'feizou', term: '飛走', isDeer: false, emoji: '🕊️', badge: '', plate: '#0f3550' },
  { id: 'fancai', term: '飯菜', isDeer: false, emoji: '🍱', badge: '', plate: '#3a3010' },
  { id: 'huang_color', term: '黃', isDeer: false, emoji: '🟨', badge: '', plate: '#3a3410' },
  { id: 'huangsan', term: '黃傘', isDeer: false, emoji: '☂️', badge: '', plate: '#3a3410' },
];
...
const TOPICS = [
  {
    ...
    cover: '📕',
    wordIds: [
      'wo', 'de', 'qiqiu', 'ne', 'fei', 'le', 'hong_color', 'huang_color', 'lan_color', 'lv_color', 'da_big', 'xiao_small', 'tianshang', 'kanjian', 'bujian', 'qule', 'nali_where', 'zheshi', 'shenme', 'a_excl', 'tanchi', 'anan', 'pingguo', 'duzi', 'tong', 'kule', 'buyao', 'zai_again', 'duo', 'xiangjiao', 'xigua', 'cheng_orange', 'hao', 'bao_full', 'ma_q', 'zhe', 'shi_be', 'shui_who', 'chi_eat', 'yusan', 'yu_rain', 'dida', 'dakai', 'shouqi', 'you_have', 'yiba', 'haokan', 'dang_block', 'shui', 'hongsan', 'huangsan', 'huasan', 'zou', 'lu_road', 'shi_wet', 'xin_letter', 'gei', 'baba', 'mama', 'gege', 'jiejie', 'didi', 'meimei', 'kan', 'xie', 'zi_char', 'yifeng_letter', 'jichu', 'lai', 'shoudao', 'kaixin', 'du', 'dong_understand', 'fen_share', 'guoguo', 'yige', 'liangge', 'sange', 'sige', 'wuge', 'dajia', 'yiqi', 'tian', 'ni', 'ta_he', 'duoshao', 'you_again', 'kuai', 'pao', 'ya_excl', 'zhui', 'gou', 'mao', 'laoshu', 'ting_stop', 'xialai', 'dabu', 'xiaoxin', 'diedao', 'hen', 'lei', 'chuanqi', 'duo_hide', 'cang', 'zhao', 'zai', 'jiao_call', 'wangwang', 'miaomiao', 'xiaogou', 'xiaomao', 'gongji', 'xiaoya', 'wa', 'qingcaodi', 'tingjian', 'shengyin', 'zaoshang', 'qichuang', 'gugu', 'guagua', 'gaga', 'huangye', 'shu_tree', 'piao', 'luo_fall', 'feng_wind', 'chui_blow', 'mandi', 'qiutian', 'sao', 'feiwu', 'meili', 'zhitou', 'guangtutu', 'jianqi', 'yipian', 'liangpian', 'wan_play', 'yishu_bunch', 'hua', 'song', 'xiexie', 'xiang_scent', 'zi_color', 'bai_color', 'kaile', 'huayuan', 'lide', 'zhai', 'xia', 'songgei', 'xihuan', 'xiao_laugh', 'lian', 'gen', 'qu', 'toufa', 'yifu', 'liangkuai', 'huhu', 'xiaole', 'daxiao', 'zhuizhu', 'zhuomicang', 'kanbujian', 'mobudao', 'qingqing', 'yongli', 'xiaoming', 'he_and', 'lazhu', 'xian_string', 'duanle', 'gao_tall', 'di_low', 'huilai', 'ku', 'shangxin', 'feizou', 'yuan_far', 'jin_near', 'dongdong', 'qingke', 'he_drink', 'pengyou', 'zuoxia', 'fancai', 'tang', 'haoweidao', 'huanying', 'zhunbei', 'wan', 'kuai_chopsticks', 'ganbei',
    ],
    books: [
    { id: 'rb_qiqiu', title: '我的氣球呢？', cover: '🎈',
      wordIds: [ 'wo', 'de', 'qiqiu', 'ne', 'fei', 'le', 'hong_color', 'huang_color', 'lan_color', 'lv_color', 'da_big', 'xiao_small', 'tianshang', 'kanjian', 'bujian', 'qule', 'nali_where', 'zheshi', 'shenme', 'a_excl' ] },
    { id: 'rb_anan', title: '貪吃的安安', cover: '😋',
      wordIds: [ 'tanchi', 'de', 'anan', 'pingguo', 'duzi', 'tong', 'kule', 'buyao', 'zai_again', 'duo', 'xiangjiao', 'xigua', 'cheng_orange', 'hao', 'bao_full', 'ma_q', 'zhe', 'shi_be', 'shui_who', 'chi_eat' ] },
    { id: 'rb_yusan', title: '雨傘', cover: '☂️',
      wordIds: [ 'yusan', 'yu_rain', 'dida', 'dakai', 'shouqi', 'da_big', 'xiao_small', 'wo', 'you_have', 'yiba', 'haokan', 'dang_block', 'shui', 'hongsan', 'huangsan', 'huasan', 'zou', 'lu_road', 'shi_wet', 'le' ] },
    { id: 'rb_xin', title: '信', cover: '✉️',
      wordIds: [ 'xin_letter', 'shui_who', 'gei', 'baba', 'mama', 'gege', 'jiejie', 'didi', 'meimei', 'kan', 'xie', 'zi_char', 'yifeng_letter', 'jichu', 'lai', 'shoudao', 'le', 'kaixin', 'du', 'dong_understand' ] },
    { id: 'rb_fenguo', title: '分果果', cover: '🍎',
      wordIds: [ 'fen_share', 'guoguo', 'yige', 'liangge', 'sange', 'sige', 'wuge', 'dajia', 'yiqi', 'chi_eat', 'hao', 'tian', 'kaixin', 'gei', 'ni', 'wo', 'ta_he', 'duoshao', 'you_again', 'lai' ] },
    { id: 'rb_kuaipao', title: '快跑呀', cover: '🏃',
      wordIds: [ 'kuai', 'pao', 'ya_excl', 'zhui', 'gou', 'mao', 'laoshu', 'ting_stop', 'xialai', 'buyao', 'zou', 'dabu', 'xiaoxin', 'diedao', 'hen', 'lei', 'chuanqi', 'duo_hide', 'cang', 'zhao' ] },
    { id: 'rb_shuijiao', title: '誰在叫', cover: '📣',
      wordIds: [ 'shui_who', 'zai', 'jiao_call', 'wangwang', 'miaomiao', 'xiaogou', 'xiaomao', 'gongji', 'xiaoya', 'wa', 'qingcaodi', 'tingjian', 'shengyin', 'da_big', 'xiao_small', 'zaoshang', 'qichuang', 'gugu', 'guagua', 'gaga' ] },
    { id: 'rb_huangye', title: '黃葉', cover: '🍂',
      wordIds: [ 'huangye', 'shu_tree', 'piao', 'luo_fall', 'xialai', 'feng_wind', 'chui_blow', 'mandi', 'qiutian', 'sao', 'feiwu', 'hen', 'meili', 'kanjian', 'zhitou', 'guangtutu', 'jianqi', 'yipian', 'liangpian', 'wan_play' ] },
    { id: 'rb_yishuhua', title: '一束花', cover: '💐',
      wordIds: [ 'yishu_bunch', 'hua', 'song', 'xiexie', 'meili', 'xiang_scent', 'hong_color', 'huang_color', 'zi_color', 'bai_color', 'kaile', 'haokan', 'huayuan', 'lide', 'zhai', 'xia', 'songgei', 'xihuan', 'xiao_laugh', 'lian' ] },
    { id: 'rb_fengwan', title: '風跟我玩', cover: '🌬️',
      wordIds: [ 'feng_wind', 'gen', 'wo', 'wan_play', 'chui_blow', 'pao', 'lai', 'qu', 'toufa', 'yifu', 'liangkuai', 'huhu', 'xiaole', 'daxiao', 'zhuizhu', 'zhuomicang', 'kanbujian', 'mobudao', 'qingqing', 'yongli' ] },
    { id: 'rb_xiaoming', title: '小明和氣球', cover: '🎈',
      wordIds: [ 'xiaoming', 'he_and', 'qiqiu', 'tianshang', 'fei', 'kan', 'lazhu', 'xian_string', 'duanle', 'zhui', 'gao_tall', 'di_low', 'huilai', 'bujian', 'ku', 'shangxin', 'feizou', 'yuan_far', 'jin_near', 'zhao' ] },
    { id: 'rb_dongdong', title: '冬冬請客', cover: '🍽️',
      wordIds: [ 'dongdong', 'qingke', 'chi_eat', 'he_drink', 'pengyou', 'lai', 'dajia', 'zuoxia', 'fancai', 'tang', 'shui', 'haoweidao', 'duoshao', 'bao_full', 'huanying', 'zhunbei', 'wan', 'kuai_chopsticks', 'ganbei', 'xiexie' ] },
    ],
  },
  {
    id: 'orange_series',
