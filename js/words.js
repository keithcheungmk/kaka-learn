...
const WORDS = [
  ...
  { id: 'jing', term: '鏡', isDeer: false, emoji: '🪞', badge: '', plate: '#2a3a50' },
...
const TOPICS = [
  ...
  },
  {
    id: 'home',
    title: '屋企',
    blurb: '廚房、睡房、浴室、桌子、衣櫃、牙刷…',
    cover: '🛋️',
    wordIds: [
      'chufang', 'shuifang', 'cesuo', 'yushi',
      'dianshi', 'xuegui', 'xiyiji', 'dianhua', 'fengshan',
      'men', 'chuanghu', 'deng', 'yizi', 'zhuozi', 'yigui', 'jing',
      'tuoxie', 'maojin', 'yashua', 'chuangpu', 'shafa',
    ],
  },
  {
    id: 'zoo',
