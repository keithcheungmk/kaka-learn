...
const WORDS = [
  ...
  // 天氣
  { id: 'ri', term: '日', isDeer: false, emoji: '☀️', badge: '', plate: '#3a3010' },
  { id: 'yue', term: '月', isDeer: false, emoji: '🌙', badge: '', plate: '#1a2040' },
  { id: 'yun', term: '雲', isDeer: false, emoji: '☁️', badge: '', plate: '#2a3548' },
  { id: 'yu_rain', term: '雨', isDeer: false, emoji: '🌧️', badge: '', plate: '#102848' },
  { id: 'xue', term: '雪', isDeer: false, emoji: '❄️', badge: '', plate: '#2a3a50' },
  { id: 'feng', term: '風', isDeer: false, emoji: '💨', badge: '', plate: '#243848' },
  { id: 'dian', term: '電', isDeer: false, emoji: '⚡', badge: '', plate: '#3a3410' },
  { id: 'caihong', term: '彩虹', isDeer: false, emoji: '🌈', badge: '', plate: '#2a1840' },
  // 交通
  { id: 'che', term: '車', isDeer: false, emoji: '🚗', badge: '', plate: '#102848' },
  ...
  { id: 'chuan', term: '船', isDeer: false, emoji: '🚢', badge: '', plate: '#0f3550' },
  { id: 'danche', term: '單車', isDeer: false, emoji: '🚲', badge: '', plate: '#143828' },
  // 身體
  { id: 'yan', term: '眼', isDeer: false, emoji: '👀', badge: '', plate: '#2a3548' },
  { id: 'erduo', term: '耳', isDeer: false, emoji: '👂', badge: '', plate: '#3a2818' },
  { id: 'bi', term: '鼻', isDeer: false, emoji: '👃', badge: '', plate: '#3a2818' },
  { id: 'kou', term: '口', isDeer: false, emoji: '👄', badge: '', plate: '#401028' },
