...
const WORDS = [
  ...
  { id: 'kan', term: '看', say: '看書', isDeer: false, emoji: '👀', badge: '看', plate: '#2a1840' },
  { id: 'lai', term: '來', isDeer: false, emoji: '➡️', badge: '', plate: '#143828' },
  { id: 'qu', term: '去', isDeer: false, emoji: '⬅️', badge: '', plate: '#3a3010' },
  { id: 'chi_eat', term: '吃', say: '吃飯', isDeer: false, emoji: '🍽️', badge: '', plate: '#401820' },
  ...
  { id: 'hao', term: '好', say: '好好', isDeer: false, emoji: '👍', badge: '', plate: '#143828' },
  { id: 'shang', term: '上', say: '上面', isDeer: false, emoji: '⬆️', badge: '', plate: '#1a3050' },
  { id: 'xia', term: '下', say: '下面', isDeer: false, emoji: '⬇️', badge: '', plate: '#102848' },
  { id: 'ai_love', term: '愛', isDeer: false, emoji: '💗', badge: '', plate: '#401028' },
  { id: 'gei', term: '給', isDeer: false, emoji: '🎁', badge: '', plate: '#2a1840' },
  { id: 'zhao', term: '找', say: '找咗', isDeer: false, emoji: '🔍', badge: '', plate: '#2a3548' },
  { id: 'shuo', term: '說', say: '說話', isDeer: false, emoji: '💬', badge: '', plate: '#1a3050' },
  ...
  { id: 'shao', term: '少', say: '好少', isDeer: false, emoji: '1️⃣', badge: '少', plate: '#2a3548' },
  ...
  { id: 'bashi_siji', term: '巴士司機', isDeer: false, emoji: '🚌🧑', emojiDuo: true, badge: '', plate: '#3a3010' },
  ...
  { id: 'jiuhuyuan', term: '救護員', isDeer: false, emoji: '🚑🧑‍⚕️', emojiDuo: true, badge: '', plate: '#401820' },
  { id: 'shouhuoyuan', term: '售貨員', isDeer: false, emoji: '🛍️🧑', emojiDuo: true, badge: '', plate: '#402038' },
  { id: 'baoan', term: '保安', isDeer: false, emoji: '🚪🧑', emojiDuo: true, badge: '', plate: '#2a2a35' },
  { id: 'qingjie_gongren', term: '清潔工人', isDeer: false, emoji: '🧹🧑', emojiDuo: true, badge: '', plate: '#143828' },
  { id: 'jiushengyuan', term: '救生員', isDeer: false, emoji: '🏊🛟', emojiDuo: true, badge: '', plate: '#0f3550' },
  { id: 'siyangyuan', term: '動物園飼養員', isDeer: false, emoji: '🦁🧑', emojiDuo: true, badge: '', plate: '#3a3010' },
  { id: 'chuanzhang', term: '船長', isDeer: false, emoji: '⚓🧑', emojiDuo: true, badge: '', plate: '#0f3550' },
  { id: 'yufu', term: '漁夫', isDeer: false, emoji: '🎣🧑', emojiDuo: true, badge: '', plate: '#0f3550' },
  { id: 'songhuoyuan', term: '送貨員', isDeer: false, emoji: '📦🧑', emojiDuo: true, badge: '', plate: '#3a3010' },
  { id: 'sheyingshi', term: '攝影師', isDeer: false, emoji: '📷', badge: '', plate: '#2a2a35' },
  { id: 'xiaozhang', term: '校長', isDeer: false, emoji: '🏫🧑', emojiDuo: true, badge: '', plate: '#102848' },
  { id: 'jiawu_zhuli', term: '家務助理', isDeer: false, emoji: '🏠🧹', emojiDuo: true, badge: '', plate: '#3a3010' },
  { id: 'shiying', term: '侍應', isDeer: false, emoji: '🍽️🧑', emojiDuo: true, badge: '', plate: '#402038' },
  { id: 'shouyinyuan', term: '收銀員', isDeer: false, emoji: '🧾🧑', emojiDuo: true, badge: '', plate: '#143828' },
  { id: 'yaojishi', term: '藥劑師', isDeer: false, emoji: '💊🧑', emojiDuo: true, badge: '', plate: '#102848' },
  { id: 'yuanding', term: '園丁', isDeer: false, emoji: '🪴🧑', emojiDuo: true, badge: '', plate: '#143828' },
  { id: 'diksi_siji', term: '的士司機', isDeer: false, emoji: '🚕🧑', emojiDuo: true, badge: '', plate: '#3a3010' },
  { id: 'junren', term: '軍人', isDeer: false, emoji: '🪖', badge: '', plate: '#2a2a35' },
  { id: 'yanyuan', term: '演員', isDeer: false, emoji: '🎭', badge: '', plate: '#402038' },
  { id: 'jizhe', term: '記者', isDeer: false, emoji: '🎤📰', emojiDuo: true, badge: '', plate: '#1a3050' },
  { id: 'gongchengshi', term: '工程師', isDeer: false, emoji: '🛠️🧑', emojiDuo: true, badge: '', plate: '#3a3010' },
  ...
  { id: 'qingting', term: '蜻蜓', isDeer: false, emoji: '🪽', badge: '蜻蜓', plate: '#0f3550' },
  // 海洋動物
  ...
  { id: 'haixing', term: '海星', isDeer: false, emoji: '⭐', badge: '海星', plate: '#3a3010' },
  ...
  { id: 'du', term: '讀', say: '讀書', isDeer: false, emoji: '📖', badge: '', plate: '#1a3050' },
  { id: 'xie', term: '寫', say: '寫字', isDeer: false, emoji: '✍️', badge: '', plate: '#2a3548' },
  { id: 'hua_draw', term: '畫', isDeer: false, emoji: '🎨', badge: '', plate: '#402038' },
  { id: 'chang_sing', term: '唱', say: '唱歌', isDeer: false, emoji: '🎤', badge: '', plate: '#2a1840' },
  { id: 'hui', term: '回', say: '回家', isDeer: false, emoji: '🔙', badge: '', plate: '#143828' },
  ...
  { id: 'he_drink', term: '喝', say: '喝水', isDeer: false, emoji: '🥤', badge: '', plate: '#402410' },
  { id: 'shui_sleep', term: '睡', say: '睡覺', isDeer: false, emoji: '😴', badge: '', plate: '#1a2a4a' },
  { id: 'xing', term: '醒', say: '醒咗', isDeer: false, emoji: '⏰', badge: '', plate: '#3a3010' },
  ...
  { id: 'yao_want', term: '要', say: '要咩', isDeer: false, emoji: '🙋', badge: '', plate: '#3a3010' },
  ...
  { id: 'de', term: '的', say: '我的', isDeer: false, emoji: '📌', badge: '', plate: '#2a3548' },
  { id: 'le', term: '了', say: '好了', isDeer: false, emoji: '✅', badge: '', plate: '#143828' },
  ...
  { id: 'hui_can', term: '會', say: '會做', isDeer: false, emoji: '💪', badge: '', plate: '#143828' },
  ...
  { id: 'jiao_call', term: '叫', say: '叫名', isDeer: false, emoji: '📣', badge: '', plate: '#401820' },
  ...
  { id: 'huan', term: '還', say: '還有', isDeer: false, emoji: '↩️', badge: '', plate: '#102848' },
  ...
  { id: 'jiao_teach', term: '教', say: '教書', isDeer: false, emoji: '🧑‍🏫', badge: '', plate: '#1a3050' },
  ...
  { id: 'zhi_point', term: '指', say: '手指', isDeer: false, emoji: '👆', badge: '', plate: '#2a3548' },
  ...
  { id: 'zhong', term: '重', say: '好重', isDeer: false, emoji: '🏋️', badge: '', plate: '#2a3548' },
  ...
  { id: 'fen_share', term: '分', say: '分開', isDeer: false, emoji: '➗', badge: '', plate: '#3a3010' },
  ...
  // 紅③《雨傘》書本 PDF 印刷詞／短語（issue #57；故事頁表面形）
  { id: 'chengyusan', term: '橙雨傘', isDeer: false, emoji: '🟠☂️', emojiDuo: true, badge: '', plate: '#402410' },
  { id: 'lanyusan', term: '藍雨傘', isDeer: false, emoji: '🔵☂️', emojiDuo: true, badge: '', plate: '#102848' },
  { id: 'lvyusan', term: '綠雨傘', isDeer: false, emoji: '🟢☂️', emojiDuo: true, badge: '', plate: '#143820' },
  { id: 'huangyusan', term: '黃雨傘', isDeer: false, emoji: '🟡☂️', emojiDuo: true, badge: '', plate: '#3a3410' },
  { id: 'huayusan', term: '花雨傘', isDeer: false, emoji: '🌸☂️', emojiDuo: true, badge: '', plate: '#402038' },
  { id: 'shouqixiaoyusan', term: '收起小雨傘', isDeer: false, emoji: '🌂', badge: '', plate: '#0f3550' },
  { id: 'taiyangchulaile', term: '太陽出來了', isDeer: false, emoji: '☀️', badge: '', plate: '#3a3410' },
  { id: 'chulaile', term: '出來了', isDeer: false, emoji: '🌤️', badge: '', plate: '#3a3010' },
  // 紅輯掃描認字卡補充詞（2026-09-05；表面形完全跟卡）
  { id: 'zuo_do', term: '做', isDeer: false, emoji: '', badge: '做', plate: '#1a3050' },
  { id: 'huaer', term: '花兒', isDeer: false, emoji: '🌸', badge: '兒', plate: '#402038' },
  { id: 'songgei', term: '送給', isDeer: false, emoji: '', badge: '送', plate: '#1a3050' },
  { id: 'yiduo', term: '一朵', isDeer: false, emoji: '🌸', badge: '一', plate: '#402038' },
  { id: 'yishu', term: '一束', isDeer: false, emoji: '💐', badge: '一', plate: '#402038' },
  { id: 'zuohao', term: '做好', isDeer: false, emoji: '', badge: '好', plate: '#143828' },
  { id: 'duo_mw', term: '朵', isDeer: false, emoji: '🌸', badge: '朵', plate: '#402038' },
  { id: 'liang_two', term: '兩', isDeer: false, emoji: '2️⃣', badge: '兩', plate: '#1a3050' },
  { id: 'anan', term: '安安', isDeer: false, emoji: '👦', badge: '安', plate: '#1a3050' },
  { id: 'gutou', term: '骨頭', isDeer: false, emoji: '🦴', badge: '', plate: '#2a3548' },
  { id: 'dongdong', term: '冬冬', isDeer: false, emoji: '👦', badge: '冬', plate: '#1a3050' },
  { id: 'qingke', term: '請客', isDeer: false, emoji: '', badge: '請', plate: '#3a3010' },
  { id: 'bushi', term: '不是', isDeer: false, emoji: '', badge: '不', plate: '#2a3548' },
  { id: 'dongxi', term: '東西', isDeer: false, emoji: '', badge: '物', plate: '#2a3548' },
  { id: 'buken', term: '不肯', isDeer: false, emoji: '', badge: '不', plate: '#2a3548' },
  { id: 'henhao', term: '很好', isDeer: false, emoji: '', badge: '好', plate: '#143828' },
  { id: 'baitu', term: '白兔', isDeer: false, emoji: '🐰', badge: '白', plate: '#3a3a45' },
  { id: 'luobo', term: '蘿蔔', isDeer: false, emoji: '🥕', badge: '', plate: '#402010' },
  { id: 'chidongxi', term: '吃東西', isDeer: false, emoji: '', badge: '吃', plate: '#3a3010' },
  { id: 'chidehenhao', term: '吃得很好', isDeer: false, emoji: '', badge: '好', plate: '#143828' },
  { id: 'liugei', term: '留給', isDeer: false, emoji: '', badge: '留', plate: '#1a3050' },
  { id: 'fengguoguo', term: '分果果', isDeer: false, emoji: '🍎', badge: '分', plate: '#401820' },
  { id: 'li_pear', term: '梨', isDeer: false, emoji: '🍐', badge: '', plate: '#3a3410' },
  { id: 'cheng_char', term: '橙', isDeer: false, emoji: '🟠', badge: '橙', plate: '#402410' },
  { id: 'guoguo', term: '果果', isDeer: false, emoji: '🍎', badge: '果', plate: '#401820' },
  { id: 'shuiguo', term: '水果', isDeer: false, emoji: '🍎', badge: '果', plate: '#401820' },
  { id: 'hong_char', term: '紅', isDeer: false, emoji: '🔴', badge: '紅', plate: '#401018' },
  { id: 'huang_char', term: '黃', isDeer: false, emoji: '🟡', badge: '黃', plate: '#3a3410' },
  { id: 'lan_char', term: '藍', isDeer: false, emoji: '🔵', badge: '藍', plate: '#102848' },
  ...
  { id: 'shuizaijiao', term: '誰在叫', isDeer: false, emoji: '', badge: '誰', plate: '#3a3010' },
  { id: 'zhizhi', term: '吱吱', isDeer: false, emoji: '🐦', badge: '吱', plate: '#1a3050' },
  { id: 'miaomiao', term: '喵喵', isDeer: false, emoji: '🐱', badge: '喵', plate: '#4a2030' },
  { id: 'miemie', term: '咩咩', isDeer: false, emoji: '🐑', badge: '咩', plate: '#2a2a35' },
  { id: 'wangwang', term: '汪汪', isDeer: false, emoji: '🐶', badge: '汪', plate: '#3a3010' },
  { id: 'moumou', term: '哞哞', isDeer: false, emoji: '🐮', badge: '哞', plate: '#3a3010' },
  { id: 'wawa', term: '哇哇', isDeer: false, emoji: '👶', badge: '哇', plate: '#402038' },
  { id: 'qishui', term: '汽水', isDeer: false, emoji: '🥤', badge: '', plate: '#0f3550' },
  { id: 'shupian', term: '薯片', isDeer: false, emoji: '🍟', badge: '', plate: '#3a2818' },
  { id: 'huasheng', term: '花生', isDeer: false, emoji: '🥜', badge: '', plate: '#3a2818' },
  { id: 'tanchi', term: '貪吃', isDeer: false, emoji: '😋', badge: '貪', plate: '#3a3010' },
  { id: 'tongle', term: '痛了', isDeer: false, emoji: '', badge: '痛', plate: '#402020' },
  { id: 'tanchide', term: '貪吃的', isDeer: false, emoji: '😋', badge: '貪', plate: '#3a3010' },
  { id: 'aiyo', term: '哎喲', isDeer: false, emoji: '', badge: '痛', plate: '#402020' },
  { id: 'anande', term: '安安的', isDeer: false, emoji: '👦', badge: '安', plate: '#1a3050' },
  { id: 'xiaofanchuan', term: '小帆船', isDeer: false, emoji: '⛵', badge: '', plate: '#0f3550' },
  { id: 'xiaowanpi', term: '小頑皮', isDeer: false, emoji: '', badge: '皮', plate: '#3a3010' },
  { id: 'chuipaopao', term: '吹泡泡', isDeer: false, emoji: '', badge: '吹', plate: '#102848' },
  { id: 'genwowan', term: '跟我玩', isDeer: false, emoji: '', badge: '玩', plate: '#143828' },
  { id: 'gen', term: '跟', isDeer: false, emoji: '', badge: '跟', plate: '#2a3548' },
  { id: 'fengche', term: '風車', isDeer: false, emoji: '', badge: '風', plate: '#102848' },
  { id: 'chuiluan', term: '吹亂', isDeer: false, emoji: '', badge: '亂', plate: '#102848' },
  { id: 'zhifeiji', term: '紙飛機', isDeer: false, emoji: '✈️', badge: '紙', plate: '#102848' },
  { id: 'pian_mw', term: '片', isDeer: false, emoji: '🍂', badge: '片', plate: '#3a3410' },
  { id: 'qiutian', term: '秋天', isDeer: false, emoji: '🍂', badge: '秋', plate: '#3a3410' },
...
const TOPICS = [
  {
    ...
    { id: 'rb_yusan', verified: true, cardSource: '2026-08-11 書本 PDF（紅③《雨傘》；issue #57 附件；故事頁印刷詞／短語，封面書名「雨傘」＋末頁大字卡「出來了」）', title: '雨傘', cover: '☂️',
      wordIds: [
        'yusan', 'chengyusan', 'lanyusan', 'lvyusan', 'huangyusan', 'huayusan', 'shouqixiaoyusan', 'taiyangchulaile', 'chulaile' ] },
    { id: 'rb_xin', verified: true, cardSource: '2026-09-05 掃描書本認字卡（紅④《信》）', title: '信', cover: '✉️',
    ...
    { id: 'rb_fengwan', verified: true, cardSource: '2026-09-05 掃描書本認字卡（紅⑩《風跟我玩》）', title: '風跟我玩', cover: '🌬️',
      wordIds: ['xiaofanchuan', 'xiaowanpi', 'chuipaopao', 'genwowan', 'le', 'shi_be', 'wo', 'feng_wind', 'wan_play', 'ge_mw', 'de', 'gen', 'zhi_paper', 'toufa', 'feiji', 'fengche', 'qiqiu', 'wode', 'chuiluan', 'zhifeiji'] },
    ...
    { id: 'rb_dongdong', verified: true, cardSource: '2026-09-05 掃描書本認字卡（紅⑫《冬冬請客》）', title: '冬冬請客', cover: '🍽️',
      wordIds: ['mama', 'gutou', 'dongdong', 'wa', 'qingke', 'xiaochong', 'xiaogou', 'huamao', 'chi_eat', 'le', 'lai', 'wan_play', 'he_and', 'dou', 'ne', 'yu', 'ma_q', 'bushi', 'shuo', 'tamen', 'qing_invite', 'dongxi', 'buken', 'henhao', 'baitu', 'luobo', 'chidongxi', 'chidehenhao', 'weishenme'] },
    ],
  },
  {
    id: 'orange_series',
  ...
  },
  {
    id: 'jobs',
    title: '職業',
    blurb: '醫生、老師、動物園飼養員…・揀冊先溫',
    cover: '👨‍⚕️',
    wordIds: [
      'yisheng', 'hushi', 'laoshi_job', 'xiaozhang', 'xiaofangyuan', 'jingcha', 'jiuhuyuan', 'yayi', 'yaojishi',
      'faxingshi', 'shouhuoyuan', 'shouyinyuan', 'baoan', 'qingjie_gongren', 'jiawu_zhuli', 'youchai', 'songhuoyuan',
      'siji', 'bashi_siji', 'diksi_siji', 'shiying', 'yuanding', 'siyangyuan', 'shouyi', 'tushuguan_guanliyuan',
      'chushi', 'nongfu', 'jishi', 'kongjie', 'taikongren', 'kexuejia', 'huajia', 'yinyuejia', 'yundongyuan',
      'yanyuan', 'jizhe', 'jianzhu_gongren', 'gongchengshi', 'chuanzhang', 'yufu', 'jiushengyuan', 'sheyingshi',
      'junren', 'huanbao_zhuren', 'yiliao_xiaoshou',
    ],
    books: [
      {
        id: 'jobs_nearby',
...
/**
 * 中文認字一律交畀裝置本身畫 Emoji：iPhone／iPad 會用 Apple Color Emoji。
 * 英文 Phonics 仍然經 js/emoji-art.js 使用 OpenMoji，所以唔可以改全域 helper。
 */
function nativeEmoji(emoji) {
...
function wordIllustHtml(word) {
  ...
  return `<span class="emoji-plate" style="--plate:${word.plate || '#122848'}">
    <span class="${faceClass}" aria-hidden="true">${nativeEmoji(word.emoji)}</span>
    ${badge}
  </span>`;
}
